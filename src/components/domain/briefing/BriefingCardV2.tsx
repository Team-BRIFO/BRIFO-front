...
export interface BriefingCardV2Props {
...
export function BriefingCardV2({
  type,
  active = false,
  rank,
  stock,
  ...
  if (type === '완료') {
    ...
    if (active) {
      ...
      borderClass = 'border-Pink-40' // 피그마 액티브 테두리
      bottomBgClass = 'bg-Pink-80'
    } else {
    ...
    if (active) {
      ...
      borderClass = 'border-Gray-3' // 피그마 액티브 테두리 명세
