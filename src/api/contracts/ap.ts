...
/**
 * 백엔드는 AP 거래 시각을 Asia/Seoul 기준의 offset 없는 LocalDateTime으로 반환한다.
 * generated OpenAPI schema가 요구하는 RFC 3339 datetime으로 정규화한 뒤 검증한다.
 */
function normalizeApTransactionDateTimes(response: unknown): unknown {
...
export const ApTransactionsResponseSchema = z.preprocess(
  normalizeApTransactionDateTimes,
