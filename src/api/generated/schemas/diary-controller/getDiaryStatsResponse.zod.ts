...
export const GetDiaryStatsResponse = zod.object({
  summary: zod.object({
...
export type GetDiaryStatsResponse = zod.input<typeof GetDiaryStatsResponse>
export type GetDiaryStatsResponseOutput = zod.output<typeof GetDiaryStatsResponse>
